...
"""
@author: favomj
blog地址: https://blog.csdn.net/qq_34798152/article/details/79463501
"""
import random
import time
...
class Crack():
    def __init__(self, username, passwd):
        ...
        self.browser = webdriver.Chrome(executable_path="F:\ChromeDriver\chromedriver.exe")
    ...
    def get_track(self, distance):
        ...
        # TODO: 这里模拟轨迹已经不行了, 会被识别出来, 需要改善轨迹, 可以尝试使用机器学习建立模型模拟鼠标拖动曲线
    ...
    def move_to_gap(self, slider, track):
        ...
        while track:
            ...
            ActionChains(self.browser).move_by_offset(xoffset=x, yoffset=random.random()).perform()
            track.remove(x)
        # time.sleep(0.5)
